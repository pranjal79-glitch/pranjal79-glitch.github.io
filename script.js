...
// --- 6. GSAP APPLE-STYLE SCROLL CHOREOGRAPHY ---
if (typeof gsap !== 'undefined') {
    ...
    gsap.utils.toArray('.about-content, .project-card, .social-icon-btn').forEach(el => {
        gsap.fromTo(el, 
            { opacity: 0, y: 50 }, 
            { opacity: 1, y: 0, duration: 1, ease: "power2.out", scrollTrigger: { trigger: el, start: "top 85%", toggleActions: "play reverse play reverse" } }
        );
    });
}
